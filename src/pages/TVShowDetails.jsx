...
import { fetchTVShow, removeTVShows } from '../store/actions/TVShowsActions';
...
const TVShowDetail = () => {
  ...
  const tvShow = useSelector((state) => state.tvShows.info);
    ...
    <div className="bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen text-white">
      <div className="container p-6 mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          />
          <h1 className="text-3xl font-bold text-white">{detail.title || detail.name}</h1>
        </div>
